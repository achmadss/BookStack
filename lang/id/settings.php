...
return [
    ...
    // Sorting Settings
    'sorting' => 'Daftar & Penyortiran',
    'sorting_book_default' => 'Aturan Penyortiran Buku Default',
    ...
    'sorting_page_limits' => 'Batas Tampilan Per Halaman',
    'sorting_page_limits_desc' => 'Tetapkan berapa banyak item yang akan ditampilkan per halaman dalam berbagai daftar dalam sistem. Biasanya jumlah yang lebih rendah akan lebih berkinerja, sementara jumlah yang lebih tinggi menghindari kebutuhan untuk mengklik melalui beberapa halaman. Menggunakan kelipatan genap dari 3 (18, 24, 30, dll...) direkomendasikan.',
    ...
    'role_permission_note_users_and_roles' => 'Izin ini secara teknis juga akan memberikan visibilitas & pencarian pengguna & peran dalam sistem.',
    ...
    'role_asset_image_view_note' => 'Ini berkaitan dengan visibilitas dalam pengelola gambar. Akses aktual ke file gambar yang diunggah akan bergantung pada opsi penyimpanan gambar sistem.',
    'role_asset_users_note' => 'Izin ini secara teknis juga akan memberikan visibilitas & pencarian pengguna dalam sistem.',
    'role_all' => 'Semua',
    'role_own' => 'Sendiri',
    'role_controlled_by_asset' => 'Dikendalikan oleh aset tempat mereka diunggah',
    'role_save' => 'Simpan Peran',
    'role_users' => 'Pengguna dalam peran ini',
    'role_users_desc' => 'Lihat semua pengguna yang telah ditugaskan ke peran ini. Pengguna dapat ditugaskan ke peran dalam formulir edit pengguna.',
    'role_users_none' => 'Saat ini tidak ada pengguna yang ditugaskan untuk peran ini',

    // Users
    'users' => 'Pengguna',
    'users_index_desc' => 'Buat dan kelola akun pengguna individual dalam sistem. Akun pengguna digunakan untuk masuk dan atribusi konten & aktivitas. Izin akses terutama berbasis peran tetapi kepemilikan konten pengguna, di antara faktor lainnya, juga dapat memengaruhi izin & akses.',
    ...
    'users_password_desc' => 'Tentukan kata sandi yang digunakan untuk masuk ke aplikasi. Ini harus terdiri dari setidaknya 8 karakter.',
    ...
    'users_external_auth_id_desc' => 'Saat sistem otentikasi eksternal digunakan (seperti SAML2, OIDC, atau LDAP) ini adalah ID yang menghubungkan pengguna BookStack ini ke akun sistem otentikasi tersebut. Anda dapat mengabaikan bidang ini jika menggunakan otentikasi berbasis email default.',
    'users_password_warning' => 'Isi hanya jika Anda ingin mengubah kata sandi untuk pengguna ini.',
    ...
    'users_social_accounts_desc' => 'Lihat status akun sosial yang terhubung untuk pengguna ini. Akun sosial dapat digunakan sebagai tambahan untuk sistem otentikasi utama untuk akses sistem.',
    ...
    'users_api_tokens_desc' => 'Buat dan kelola token akses yang digunakan untuk mengautentikasi dengan BookStack REST API. Izin untuk API dikelola melalui pengguna yang token tersebut dimiliki.',
    ...
    'users_mfa_desc' => 'Siapkan otentikasi multi-faktor sebagai lapisan keamanan tambahan untuk akun pengguna Anda.',
    'users_mfa_x_methods' => ':count metode dikonfigurasi|:count metode dikonfigurasi',
    'users_mfa_configure' => 'Konfigurasi Metode',
    ...
    'user_groups_index_desc' => 'Grup pengguna memungkinkan Anda mengatur pengguna dan memberi mereka akses hanya-lihat ke rak atau buku tertentu. Anggota grup dapat melihat semua konten yang ditetapkan ke grup mereka, dengan akses hierarkis yang otomatis diterapkan pada konten turunan.',
    'user_group' => 'Grup Pengguna',
    'user_group_create' => 'Buat Grup Pengguna',
    'user_group_edit' => 'Edit Grup Pengguna',
    'user_group_delete' => 'Hapus Grup Pengguna',
    'user_group_details' => 'Detail Grup Pengguna',
    'user_group_details_desc' => 'Tetapkan nama dan deskripsi untuk grup ini. Anggota grup akan menerima akses hanya-lihat ke konten yang ditetapkan.',
    'user_group_name' => 'Nama Grup',
    'user_group_desc' => 'Deskripsi Grup (Opsional)',
    'user_group_save' => 'Simpan Grup Pengguna',
    'user_group_members' => 'Anggota Grup',
    'user_group_members_desc' => 'Pilih pengguna untuk ditambahkan ke grup ini. Anggota akan menerima akses hanya-lihat ke semua konten yang ditetapkan ke grup.',
    'user_group_add_users' => 'Tambahkan Pengguna',
    'user_group_select_user' => 'Pilih pengguna',
    'user_group_current_members' => 'Anggota Saat Ini',
    'user_group_available_users' => 'Pengguna Tersedia',
    'user_group_no_members' => 'Tidak ada pengguna yang saat ini ditugaskan ke grup ini.',
    'user_group_content' => 'Akses Konten Grup',
    'user_group_content_desc' => 'Pilih rak dan buku mana yang dapat dilihat oleh anggota grup ini. Memberikan akses rak secara otomatis memberikan akses ke semua buku dalam rak tersebut.',
    'user_group_add_shelves' => 'Tambahkan Rak',
    'user_group_add_books' => 'Tambahkan Buku',
    'user_group_available_shelves' => 'Rak Tersedia',
    'user_group_available_books' => 'Buku Tersedia',
    'user_group_assigned_content' => 'Konten yang Ditetapkan',
    'user_group_select_shelf' => 'Pilih rak',
    'user_group_select_book' => 'Pilih buku',
    'user_group_add_shelf' => 'Tambahkan Rak',
    'user_group_add_book' => 'Tambahkan Buku',
    'user_group_no_content' => 'Tidak ada konten yang saat ini ditugaskan ke grup ini.',
    'user_group_no_description' => 'Tidak ada deskripsi yang diberikan',
    'user_groups_x_users' => ':count pengguna|:count pengguna',
    'user_groups_x_content' => ':count item|:count item',
    'user_group_delete_warning' => 'Ini akan sepenuhnya menghapus grup pengguna ini dengan nama \':groupName\' dari sistem.',
    'user_group_delete_confirm' => 'Apakah Anda yakin ingin menghapus grup pengguna ini?',
    'user_group_save_changes' => 'Simpan Perubahan',
    'user_group_filter_by_role_tip' => 'Tip: Gunakan <code>role:NamaPeran</code> untuk memfilter berdasarkan peran (misal, <code>role:Admin</code>, <code>role:Editor</code>)',
    'user_group_filter_by_type_tip' => 'Tip: Gunakan <code>type:shelf</code> atau <code>type:book</code> untuk memfilter berdasarkan tipe',

    // Webhooks
    'webhooks' => 'Webhook',
    'webhooks_index_desc' => 'Webhook adalah cara untuk mengirim data ke URL eksternal ketika tindakan dan peristiwa tertentu terjadi dalam sistem yang memungkinkan integrasi berbasis peristiwa dengan platform eksternal seperti sistem pesan atau notifikasi.',
    'webhooks_x_trigger_events' => ':count peristiwa pemicu|:count peristiwa pemicu',
    'webhooks_create' => 'Buat Webhook Baru',
    'webhooks_none_created' => 'Belum ada webhook yang dibuat.',
    'webhooks_edit' => 'Edit Webhook',
    'webhooks_save' => 'Simpan Webhook',
    'webhooks_details' => 'Detail Webhook',
    'webhooks_details_desc' => 'Berikan nama yang ramah pengguna dan titik akhir POST sebagai lokasi untuk data webhook dikirim.',
    'webhooks_events' => 'Peristiwa Webhook',
    'webhooks_events_desc' => 'Pilih semua peristiwa yang harus memicu webhook ini dipanggil.',
    'webhooks_events_warning' => 'Ingat bahwa peristiwa ini akan dipicu untuk semua peristiwa yang dipilih, bahkan jika izin khusus diterapkan. Pastikan penggunaan webhook ini tidak mengekspos konten rahasia.',
    'webhooks_events_all' => 'Semua peristiwa sistem',
    'webhooks_name' => 'Nama Webhook',
    'webhooks_timeout' => 'Batas Waktu Permintaan Webhook (Detik)',
    'webhooks_endpoint' => 'Titik Akhir Webhook',
    'webhooks_active' => 'Webhook Aktif',
    'webhook_events_table_header' => 'Peristiwa',
    'webhooks_delete' => 'Hapus Webhook',
    'webhooks_delete_warning' => 'Ini akan sepenuhnya menghapus webhook ini, dengan nama \':webhookName\', dari sistem.',
    'webhooks_delete_confirm' => 'Apakah Anda yakin ingin menghapus webhook ini?',
    'webhooks_format_example' => 'Contoh Format Webhook',
    'webhooks_format_example_desc' => 'Data webhook dikirim sebagai permintaan POST ke titik akhir yang dikonfigurasi sebagai JSON mengikuti format di bawah ini. Properti "related_item" dan "url" bersifat opsional dan akan tergantung pada jenis peristiwa yang dipicu.',
    'webhooks_status' => 'Status Webhook',
    'webhooks_last_called' => 'Terakhir Dipanggil:',
    'webhooks_last_errored' => 'Terakhir Error:',
    'webhooks_last_error_message' => 'Pesan Error Terakhir:',

    // Licensing
    'licenses' => 'Lisensi',
    'licenses_desc' => 'Halaman ini merinci informasi lisensi untuk BookStack selain proyek & pustaka yang digunakan dalam BookStack. Banyak proyek yang tercantum mungkin hanya digunakan dalam konteks pengembangan.',
