...
return [
    ...
    'audit_export_csv' => 'Export to CSV',
    'audit_date' => 'Date',
    'audit_user' => 'User',
    'audit_event' => 'Event',
    'audit_detail' => 'Detail',
    ...
    'role_details_desc' => 'Set a name and description for this role. Role users will receive permissions assigned to the role.',
    'role_name' => 'Role Name',
    ...
    'role_users_desc' => 'View all users that have been assigned this role. Users can be assigned to roles within the user edit form.',
    ...
    'users_employee_id_desc' => 'Enter the employee identification number for this user. Cannot contain @ symbol.',
    ...
    'user_groups_index_desc' => 'User groups allow you to organize users and grant them view-only access to specific shelves or books. Members of a group can view all content assigned to their groups, with hierarchical access automatically applied to child content.',
    ...
    'user_group_add_users' => 'Add Users',
    'user_group_select_user' => 'Select a user',
    'user_group_current_members' => 'Current Members',
    'user_group_available_users' => 'Available Users',
    'user_group_no_members' => 'No users are currently assigned to this group.',
    'user_group_content' => 'Group Content Access',
    'user_group_content_desc' => 'Select which shelves and books members of this group can view. Granting shelf access automatically provides access to all books within that shelf.',
    'user_group_add_shelves' => 'Add Shelves',
    'user_group_add_books' => 'Add Books',
    'user_group_available_shelves' => 'Available Shelves',
    'user_group_available_books' => 'Available Books',
    'user_group_assigned_content' => 'Assigned Content',
    'user_group_select_shelf' => 'Select a shelf',
    'user_group_select_book' => 'Select a book',
    'user_group_add_shelf' => 'Add Shelf',
    'user_group_add_book' => 'Add Book',
    'user_group_no_content' => 'No content is currently assigned to this group.',
    'user_group_no_description' => 'No description provided',
    'user_groups_x_users' => ':count user|:count users',
    'user_groups_x_content' => ':count item|:count items',
    'user_group_delete_warning' => 'This will fully delete this user group with the name \':groupName\' from the system.',
    'user_group_delete_confirm' => 'Are you sure you want to delete this user group?',
    'user_group_save_changes' => 'Save Changes',
    'user_group_filter_by_role_tip' => 'Tip: Use <code>role:RoleName</code> to filter by role (e.g., <code>role:Admin</code>, <code>role:Editor</code>)',
    'user_group_filter_by_type_tip' => 'Tip: Use <code>type:shelf</code> or <code>type:book</code> to filter by type',
